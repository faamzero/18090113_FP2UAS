    ...
    <div class="container mt-3">
        <form action="{{route('buku.store')}} " method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="number" name="nip" class="form-control" id="exampleInputEmail1" placeholder="Masukkan No NIP">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1" class="font-weight-bold">Nama Pegawai</label>
              <input type="text" name="nama_pegawai" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Nama Pegawai">
            </div>
            <div class="form-group">
